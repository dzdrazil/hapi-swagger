...
internals.getRoutesData = function (routes, settings) {
    ...
    routes.forEach(function (route) {
        ...
        if (settings.authorizations && settings.authorizations.default) {
            routeData.authorizations[settings.authorizations['default'].type] = settings.authorizations['default']
        }
